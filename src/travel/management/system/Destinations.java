...
public class Destinations extends JFrame implements Runnable{ 
    ...
    public void run(){
        String[] text = new String[]{"JW Marriot Hotel", "Madarin Oriental Hotel", "Four Seasons Hotel", "Raddisson Blue Hotel","Classical Hotel","The Bay Club Hotel","Breeze Blow Hotel","The Taj Hotel","Happy Morning Motel","7S Hotels"};
        try{
            for(int i = 0; i < 9; i++){
...
//        caption = new JLabel();
//        caption.setBounds(50,500,500,400);
